...
template<typename ExpectedType, typename ArgType, typename PtrTraits, template <typename> typename RefDerefTraits>
...
template<typename Target, typename Source, typename PtrTraits, template <typename> typename RefDerefTraits>
